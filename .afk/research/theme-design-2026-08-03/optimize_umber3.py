#!/usr/bin/env python3
"""
optimize_umber3.py — third pass. Targets set by ROLE, hue integrity made hard.
...
Run: python3 optimize_umber3.py
"""
...
def bounds():
    b = [(0.90, 0.965), (0.255, 0.335), (0.60, 0.74), (0.845, 0.915), (0.955, 0.995)]
    for name, hr, lr, cr, cbf, floor in FAMILIES:
...
def main():
    ...
    import json
    with open("umber-palette-v3.json", "w") as f:
        json.dump({"_source": "optimize_umber3.py", "background": BG, "foreground": fg, "cursor": cursor,
                   "selection": sel, "ansi": ansi,
                   "score": bs, "unmet": [n for n, _ in fails]}, f, indent=2)
    print("\n  wrote umber-palette-v3.json")
