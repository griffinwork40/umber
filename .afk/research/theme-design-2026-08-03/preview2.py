...
CANDIDATES = [
    dict(name="Umber D — eye-approved lightnesses", **{'bg': '#19120D', 'fg': '#E5DFD6', 'cursor': '#FF9B5A', 'sel': '#453021'},
         note="yellow L 0.759, green L 0.844. red/yellow dichromacy 0.083 (tier-2 level).",
         ansi=['#342C26', '#EF7F74', '#8AE49E', '#D7AA32', '#739EF0', '#FFACE9', '#42CBC8', '#D3CDC5', '#AAA19B', '#F9A69C', '#B4FCC2', '#F7D179', '#9BBCFA', '#FFD2F2', '#80E5E2', '#F9F6F2']),
    dict(name="Umber E — tier-1 compliant", **{'bg': '#19120D', 'fg': '#E5DFD6', 'cursor': '#FF9B5A', 'sel': '#453021'},
         note="yellow L 0.810, green L 0.890. all warm pairs >= 0.114; green paler.",
         ansi=['#342C26', '#EF7F74', '#99F3AC', '#E8BA46', '#739EF0', '#FFACE9', '#42CBC8', '#D3CDC5', '#AAA19B', '#F9A69C', '#D9FFE0', '#FDD880', '#9BBCFA', '#FFD2F2', '#80E5E2', '#F9F6F2']),
]
