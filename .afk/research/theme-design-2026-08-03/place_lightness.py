#!/usr/bin/env python3
"""
place_lightness.py — the last search, with the garishness axis removed.
...
Run: python3 place_lightness.py
"""
...
FAMILIES = [
    ("red",     (18.0,  32.0), (0.695, 0.775), (0.800, 0.870), 0.135, 0.098, 52.0),
...
PAIRS = [("red", "green"), ("red", "yellow"), ("green", "yellow"),
         ("blue", "magenta"), ("green", "cyan"), ("blue", "cyan"),
         ("red", "magenta"), ("red", "blue"), ("yellow", "cyan"),
         ("magenta", "cyan"), ("yellow", "magenta"), ("blue", "green")]

T_CVD, T_HUE, T_RING = 0.075, 0.100, 0.090
    ...
    for x, y in PAIRS:
        for ring, off in (("norm", 0), ("brt", 8)):
            ...
            for kd in ("protan", "deutan"):
                ...
                m.append((f"cvd {kd} {ring} {x}/{y}", (d - T_CVD) / T_CVD))
    return m
...
def main():
    ...
    with open("umber-palette.json", "w") as f:
        json.dump({"_source": "place_lightness.py — chroma pinned, L+hue searched",
