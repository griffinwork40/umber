...
enum StarterConfig {
    static let text = """
    {
      ...
      "// theme": "OMITTED BY DEFAULT, which leaves SwiftTerm's own colours in place. Installing a palette does NOT harm the 256-colour cube: this app pins ansi256PaletteStrategy to .xterm before any colour, so indices 16-255 stay the standard xterm values whatever you set. Uncomment below to pick a palette.",
      "// theme-example": {
        "preset": "umber",
        "// preset-values": "umber | afk-dark | tokyo-night | classic",
        "// preset-note": "umber is the palette designed and measured for this app: a warm umber-black base, legible dim text (the one colour nearly every other theme leaves unreadable), bright colours that are actually distinguishable from their normal counterparts, and red/green that stays separable for a red-green colour-blind reader. Verified by Scripts/check-theme-contrast.sh; the derivation is in .afk/research/theme-design-2026-08-03/.",
